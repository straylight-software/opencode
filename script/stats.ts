...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/anomalyco/weapon/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for anomalyco/weapon...\n")
...
console.log("Fetching npm all-time downloads for weapon-ai...\n")
const npmDownloads = await fetchNpmDownloads("weapon-ai")
