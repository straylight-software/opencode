...
import { IconWeapon } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "weapon/session/message-v2"
import type { Message } from "weapon/session/message"
import type { Session } from "weapon/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.weapon_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.weapon_name}>
                    <IconWeapon width={16} height={16} />
                  </div>
