...
Weapon มีเอเจนต์สองประเภท: **Primary Agent** (เอเจนต์หลัก) และ **Subagent** (เอเจนต์ย่อย)
...
Weapon มีเอเจนต์หลักในตัวได้แก่ **Build** และ **Plan**
...
Weapon มี subagent ในตัวได้แก่ **General** และ **Explore**

---

## บิวท์อิน

Weapon มาพร้อมกับเอเจนต์หลักและ subagent ในตัวดังนี้
...
กำหนดค่าเอเจนต์ในไฟล์ `weapon.json` ของคุณ:
...
- ระดับผู้ใช้ (Global): `~/.config/weapon/agents/`
- ระดับโปรเจ็กต์: `.weapon/agents/`
...
หมายเหตุ: Weapon ค่าเริ่มต้นคือ 0 สำหรับโมเดลส่วนใหญ่ และ 0.55 สำหรับโมเดล Qwen
...
:::tip
หากไม่ได้ระบุโมเดล เอเจนต์จะใช้ [โมเดลเริ่มต้น](/docs/config#models) ของ Weapon
:::
...
:::tip
ใช้ `weapon models` เพื่อดูรายการตัวเลือกทั้งหมด
:::
...
:::tip
คุณมีเอเจนต์เจ๋งๆ ที่ต้องการแบ่งปันหรือไม่? [ส่ง PR มาที่นี่](https://github.com/anomalyco/weapon)
:::
