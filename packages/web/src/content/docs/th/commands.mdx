...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ Weapon:
...
- ระดับผู้ใช้ (Global): `~/.config/weapon/commands/`
- ระดับโปรเจ็กต์: `.weapon/commands/`
...
Weapon มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
