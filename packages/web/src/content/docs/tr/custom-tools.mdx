---
title: Özel Araçlar
description: LLM'un weapon'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. weapon'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.weapon/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/weapon/tools/` içine yerleştirerek.
