...
`.weapon/commands/test.md` oluştur:
...
weapon işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

weapon [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/weapon/commands/`
- Proje başına: `.weapon/commands/`
...
weapon, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).
