---
title: Zen
description: weapon ekibinin sundugu secili model listesi.
---
...
Weapon Zen, weapon ekibi tarafindan test edilip dogrulanmis modellerin listesidir.

:::note
Weapon Zen su anda beta asamasindadir.
:::

Zen, weapon'daki diger provider'lar gibi calisir. Weapon Zen'e giris yapar ve API anahtarinizi alirsiniz.
Tamamen istege baglidir; weapon kullanmak icin Zen kullanmak zorunda degilsiniz.
...
:::tip
weapon ile iyi calisan belirli model/provider kombinasyonlarini test ettik.
:::
...
Weapon Zen, bu modellere erisim saglayan bir AI gateway'dir.

---

## Nasil calisir

Weapon Zen, weapon'daki diger provider'lar gibi calisir.

1. **<a href={console}>Weapon Zen</a>** hesabina giris yapin, odeme bilgilerinizi ekleyin ve API anahtarinizi kopyalayin
2. TUI'da `/connect` komutunu calistirin, Weapon Zen'i secin ve API anahtarinizi yapistirin
...
weapon config'inizdeki [model id](/docs/config/#models), `weapon/<model-id>` formatini kullanir.
Ornegin GPT 5.2 Codex icin config'te `weapon/gpt-5.2-codex` kullanirsiniz.
...
- GLM 4.7 Free, sinirli bir sure icin weapon'da ucretsizdir. Ekip bu surede geri bildirim toplayip modeli iyilestiriyor
- Kimi K2.5 Free, sinirli bir sure icin weapon'da ucretsizdir. Ekip bu surede geri bildirim toplayip modeli iyilestiriyor
- MiniMax M2.1 Free, sinirli bir sure icin weapon'da ucretsizdir. Ekip bu surede geri bildirim toplayip modeli iyilestiriyor
- Big Pickle, sinirli bir sure icin weapon'da ucretsiz olan gizli bir modeldir. Ekip bu surede geri bildirim toplayip modeli iyilestiriyor
...
Weapon Zen'i su amaclarla olusturduk:
...
4. Herhangi bir kodlama ajaniyla kullanima izin vererek **kilitlenmeyi onlemek** ve weapon'da diger provider'lari her zaman acik tutmak
