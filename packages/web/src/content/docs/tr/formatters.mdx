...
description: weapon dile özgü biçimlendiriciler kullanır.
---

weapon, dosyaları dile özgü formatlayıcılar kullanılarak yazıldıktan veya düzenlendikten sonra otomatik olarak formatlar. Bu, oluşturulan kodun projenizin kod stillerine uymasını sağlar.

---

## Yerleşik

weapon, popüler diller ve çerçeveler için çeşitli yerleşik biçimlendiricilerle birlikte gelir. Aşağıda ihtiyaç duyduğu biçimlendiricilerin, desteklenen dosya uzantılarının ve komutların veya yapılandırma seçeneklerinin bir listesi bulunmaktadır.
...
Yani eğer projenizin `package.json` dosyasında `prettier` varsa, weapon bunu otomatik olarak kullanacaktır.

---

## Nasıl çalışır?

weapon bir dosyayı yazdığında veya düzenlediğinde:
...
Biçimlendiricileri weapon yapılandırmanızdaki `formatter` bölümü aracılığıyla özelleştirebilirsiniz.
