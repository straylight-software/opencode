---
title: Paylasim
description: weapon konusmalarini genel baglantilarla paylasin.
---

weapon'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda weapon:
...
weapon, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak weapon manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `weapon.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda weapon kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
