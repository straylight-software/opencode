---
title: TUI
description: weapon terminal arayuzunu kullanin.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

weapon, projelerinizde LLM ile calismak icin etkilesimli bir terminal arayuzu (TUI) sunar.

weapon'u calistirdiginizda mevcut dizin icin TUI baslar.
...
weapon TUI kullanirken `/` ve komut adini yazarak hizli eylemler calistirabilirsiniz. Ornek:
...
weapon'a bir provider ekler. Mevcut provider'lari secip API anahtarlari eklemenizi saglar.
...
weapon'dan cikar. _Takma adlar_: `/quit`, `/q`
...
TUI davranisini weapon config dosyanizdan ozellestirebilirsiniz.
