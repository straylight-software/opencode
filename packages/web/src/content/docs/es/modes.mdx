...
:::caution
Los modos ahora se configuran a través de la opción `agent` en la configuración weapon. El
La opción `mode` ahora está en desuso. [Más información](/docs/agents).
:::

Los modos en weapon le permiten personalizar el comportamiento, las herramientas y las indicaciones para diferentes casos de uso.

Viene con dos modos integrados: **construir** y **planificar**. Puedes personalizar
estos o configure el suyo propio a través de la configuración weapon.
...
weapon viene con dos modos integrados.
...
- `edit` - No se pueden modificar archivos existentes, excepto los archivos ubicados en `.weapon/plans/*.md` para detallar el plan en sí.
...
Configure los modos en su archivo de configuración `weapon.json`:
...
tanto la configuración global weapon como la configuración específica del proyecto.
...
Cree archivos de modo en `.weapon/modes/` para modos específicos del proyecto o `~/.config/weapon/modes/` para modos globales:
