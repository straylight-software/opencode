...
Puede agregar comandos personalizados a través de la configuración Weapon o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su Weapon [config](/docs/config):
...
weapon incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
