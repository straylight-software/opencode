...
يوجد نوعان من الوكلاء في Weapon: وكلاء أساسيون ووكلاء فرعيون.
...
يأتي Weapon مع وكيلين أساسيين مدمجين: **Build** و **Plan**. سنلقي نظرة عليهما أدناه.
...
يأتي Weapon مع وكيلين فرعيين مدمجين: **General** و **Explore**. سنلقي نظرة على ذلك أدناه.

---

## المدمجة

يأتي Weapon مع وكيلين أساسيين مدمجين ووكيلين فرعيين مدمجين.
...
هيّئ الوكلاء في ملف إعدادات `weapon.json`:
...
- عام: `~/.config/weapon/agents/`
- لكل مشروع: `.weapon/agents/`
...
إذا لم يتم تحديد temperature، يستخدم Weapon القيم الافتراضية الخاصة بالنموذج؛ عادة 0 لمعظم النماذج و 0.55 لنماذج Qwen.
...
هذا المسار نسبي لمكان وجود ملف الإعدادات. لذلك يعمل هذا لكل من إعدادات Weapon العامة وإعدادات المشروع.
...
يستخدم معرّف النموذج في إعدادات Weapon الصيغة `provider/model-id`. على سبيل المثال، إذا كنت تستخدم [Weapon Zen](/docs/zen)، فستستخدم `weapon/gpt-5.1-codex` لـ GPT 5.1 Codex.
...
:::tip
شغّل `weapon models` لعرض قائمة بالنماذج المتاحة.
:::
...
:::tip
هل لديك وكيل تود مشاركته؟ [قدّم PR](https://github.com/anomalyco/weapon).
:::
