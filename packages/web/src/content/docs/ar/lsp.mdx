---
title: خوادم LSP
description: يتكامل Weapon مع خوادم LSP لديك.
---

يتكامل Weapon مع بروتوكول خادم اللغة (LSP) لمساعدة LLM على التفاعل مع قاعدة الشيفرة لديك. ويستخدم التشخيصات لتزويد LLM بتغذية راجعة.

---

## المدمجة

يأتي Weapon مع عدة خوادم LSP مدمجة للغات الشائعة:
...
:::note
يمكنك تعطيل تنزيلات خوادم LSP التلقائية عبر ضبط متغير البيئة `WEAPON_DISABLE_LSP_DOWNLOAD` على `true`.
:::
...
يمكنك تخصيص خوادم LSP عبر قسم `lsp` في إعدادات weapon.
