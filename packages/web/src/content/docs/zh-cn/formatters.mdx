---
title: 格式化程序
description: weapon 使用特定于语言的格式化程序。
---

使用特定于语言的格式化程序编写或编辑文件后，weapon 会自动格式化文件。这可以确保生成的代码遵循项目的代码风格。

---

## 内置

weapon 附带了多个适用于流行语言和框架的内置格式化程序。下面是格式化程序、支持的文件扩展名以及所需的命令或配置选项的列表。
...
因此，如果您的项目的 `prettier` 中有 `package.json`，weapon 将自动使用它。
...
您可以通过 weapon 配置中的 `formatter` 部分自定义格式化程序。
