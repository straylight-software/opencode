...
您可以通过 weapon 配置或通过在 `commands/` 目录中创建 markdown 文件来添加自定义命令。

---

### JSON

在 weapon [配置](/docs/config) 中使用 `command` 选项：
...
- 全局：`~/.config/weapon/commands/`
- 每个项目：`.weapon/commands/`
...
weapon 包含 `/init`、`/undo`、`/redo`、`/share`、`/help` 等内置命令；[了解更多](/docs/tui#commands)。
