---
title: 服务器
description: 通过 HTTP 与 weapon 服务器交互。
---
...
:::tip
使用weapon服务器以程序设计方式与weapon交互。
:::

该架构让 weapon 支持客户端，并允许您以多种设计方式与 weapon 交互。
...
[**_T2_**](#tui) 端点可用于跨境服务器驱动 TUI。例如，您可以预填充或执行提示。此设置由 weapon [IDE](/docs/ide) 外挂使用。
