...
Agentferdigheter lar Weapon oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
Weapon søker etter disse stedene:

- Prosjektkonfigurasjon: `.weapon/skills/<name>/SKILL.md`
- Global konfigurasjon: `~/.config/weapon/skills/<name>/SKILL.md`
...
For prosjektlokale stier går Weapon opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
Den laster alle matchende `skills/*/SKILL.md` i `.weapon/` og alle matchende `.claude/skills/*/SKILL.md` eller `.agents/skills/*/SKILL.md` underveis.

Globale definisjoner lastes også inn fra `~/.config/weapon/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` og `~/.agents/skills/*/SKILL.md`.
...
Lag `.weapon/skills/git-release/SKILL.md` slik:
...
Weapon viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved at bruge mønsterbaserte tillatelser i `weapon.json`:
...
**For innebygde agenter** (i `weapon.json`):
