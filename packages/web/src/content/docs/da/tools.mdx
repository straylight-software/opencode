...
Her er alle de innebygde verktøyene som er tilgængelige i Weapon.
...
:::note
Dette verktøyet er bare tilgængelig når `WEAPON_EXPERIMENTAL_LSP_TOOL=true` (eller `WEAPON_EXPERIMENTAL=true`).
:::
...
:::note
Dette verktøyet er bare tilgængelig når du bruger Weapon-leverandøren eller når miljøvariabelen `WEAPON_ENABLE_EXA` er satt til en sannverdi (f.eks. `true` eller `1`).
