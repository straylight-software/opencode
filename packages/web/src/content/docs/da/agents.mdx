...
Der er to typer agenter i Weapon; primære agenter og subagenter.
...
Weapon leveres med indbyggede primære agenter, **Build** og **Plan**. Vi vil
...
Weapon leveres med to indbyggede underagenter, **Generelt** og **Udforsk**. Vi vil se på dette nedenfor.

---

## Indbyggede

Weapon leveres med to indbyggede primære agenter og to indbyggede subagenter.
...
Konfigurer agent i din `weapon.json`-konfigurationsfil:
...
Hvis ingen temperatur er angivet, bruger Weapon modelspecifikke standardindstillinger; typisk 0 for de fleste modeller, 0,55 for Qwen-modeller.
...
Denne sti er i forhold til, hvor konfigurationsfilen er placeret. Så dette virker både for den globale Weapon-konfiguration og den projektspecifikke konfiguration.
...
Model-id'et i din Weapon-konfiguration brugerformatet `provider/model-id`. For eksempel, hvis du bruger [Weapon Zen](/docs/zen), vil du bruge `weapon/gpt-5.1-codex` til GPT 5.1 Codex.
...
:::tip
Kør `weapon models` for at se en liste over de tilgængelige modeller.
:::
...
:::tip
Har du en agent, du gerne vil dele? [Send en PR](https://github.com/anomalyco/weapon).
:::
