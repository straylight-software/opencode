...
description: Opret værktøjer, som LLM kan kalde weapon ind.
---

Brugerdefinerede værktøjer er funktioner, du opretter, som LLM kan kalde under samtaler. De arbejder sammen med weapons [built-in tools](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved at placere dem i biblioteket `.weapon/tools/` i dit projekt.
- Eller globalt ved at placere dem i `~/.config/weapon/tools/`.
