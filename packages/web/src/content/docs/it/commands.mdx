...
Puoi aggiungere comandi personalizzati tramite la config di Weapon o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di Weapon:
...
- Globale: `~/.config/weapon/commands/`
- Per progetto: `.weapon/commands/`
...
weapon include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
