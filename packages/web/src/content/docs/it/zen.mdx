---
title: Zen
description: Lista curata di modelli fornita da Weapon.
---
...
Weapon Zen e una lista di modelli testati e verificati dal team di Weapon.

:::note
Weapon Zen e attualmente in beta.
:::

Zen funziona come qualunque altro provider in Weapon. Accedi a Weapon Zen e ottieni la tua chiave API. E **completamente opzionale**: non devi usarlo per usare Weapon.
...
:::tip
Abbiamo testato un gruppo selezionato di modelli e provider che funzionano bene con Weapon.
:::
...
Weapon Zen e un gateway AI che ti da accesso a questi modelli.

---

## Come funziona

Weapon Zen funziona come qualunque altro provider in Weapon.

1. Accedi a **<a href={console}>Weapon Zen</a>**, aggiungi i dettagli di fatturazione e copia la chiave API.
2. Esegui il comando `/connect` nella TUI, seleziona Weapon Zen e incolla la chiave API.
...
Il [model id](/docs/config/#models) nella config di Weapon usa il formato `weapon/<model-id>`. Per esempio, per GPT 5.2 Codex useresti `weapon/gpt-5.2-codex` nella config.
...
- GLM 4.7 Free e disponibile su Weapon per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
- Kimi K2.5 Free e disponibile su Weapon per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
- MiniMax M2.1 Free e disponibile su Weapon per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
- Big Pickle e un modello stealth gratuito su Weapon per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
...
4. Evitare **lock-in** permettendoti di usarlo con qualunque altro agente di coding e lasciandoti sempre usare anche altri provider con Weapon.
