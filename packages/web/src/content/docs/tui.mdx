---
title: TUI
description: Using the Weapon terminal user interface.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Weapon provides an interactive terminal interface or TUI for working on your projects with an LLM.

Running Weapon starts the TUI for the current directory.
...
When using the Weapon TUI, you can type `/` followed by a command name to quickly execute actions. For example:
