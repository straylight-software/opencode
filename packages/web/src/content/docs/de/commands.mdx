...
Erstellen Sie `.weapon/commands/test.md`:

```md title=".weapon/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die Weapon-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem Weapon [config](/docs/config):

```json title="weapon.jsonc" {4-12}
{
...
- Global: `~/.config/weapon/commands/`
- Pro Projekt: `.weapon/commands/`

```markdown title="~/.config/weapon/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".weapon/commands/component.md"
---
...
```md title=".weapon/commands/create-file.md"
---
...
```md title=".weapon/commands/analyze-coverage.md"
---
...
```md title=".weapon/commands/review-changes.md"
---
...
```md title=".weapon/commands/review-component.md"
---
...
Weapon enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
