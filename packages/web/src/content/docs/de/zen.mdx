---
title: Zen
description: Kuratierte Modellliste direkt von Weapon.
---
...
Weapon Zen ist eine vom Weapon-Team getestete und verifizierte Modellliste.

:::note
Weapon Zen befindet sich aktuell in der Beta.
:::

Zen funktioniert wie jeder andere Provider in Weapon.
Du meldest dich bei Weapon Zen an, holst dir deinen API-Key und nutzt ihn optional.
...
:::tip
Wir haben eine Auswahl aus Modellen und Providern getestet, die gut mit Weapon funktionieren.
:::
...
Weapon Zen ist ein AI-Gateway, das dir Zugriff auf genau diese Modelle gibt.

---

## Funktionsweise

Weapon Zen funktioniert wie jeder andere Provider in Weapon.

1. Melde dich bei **<a href={console}>Weapon Zen</a>** an, hinterlege Zahlungsdaten und kopiere deinen API-Key.
2. Fuehre in der TUI `/connect` aus, waehle Weapon Zen und fuege den API-Key ein.
...
Die [Model-ID](/docs/config/#models) in deiner Weapon-Konfiguration hat das Format `weapon/<model-id>`.
Fuer GPT 5.2 Codex verwendest du zum Beispiel `weapon/gpt-5.2-codex`.
...
Wir haben Weapon Zen entwickelt, um:
...
4. **Kein Lock-in** zu erzwingen, damit du Zen mit anderen Coding-Agents und Weapon weiter mit anderen Providern nutzen kannst
