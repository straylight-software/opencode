---
title: TUI
description: Arbeite mit Weapon in der Terminal-Oberflaeche.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Weapon bietet eine interaktive Terminaloberflaeche (TUI), um mit einem LLM an deinen Projekten zu arbeiten.

Ohne weitere Argumente startet Weapon die TUI im aktuellen Verzeichnis.
...
In der Weapon-TUI kannst du `/` plus Befehlsnamen eingeben, um Aktionen schnell auszufuehren.
Zum Beispiel:
...
Add a provider to Weapon. Allows you to select from available providers and add their API keys.
...
You can customize TUI behavior through your Weapon config file.
