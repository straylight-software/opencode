---
title: Teilen
description: Teile Weapon-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu Weapon-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht Weapon Folgendes:
...
Weapon hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt Weapon den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`weapon.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du weapon in deiner Organisation einsetzt.
