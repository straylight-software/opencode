...
Mit Weapon kannst du ein eingebautes Theme waehlen, ein an dein Terminal angepasstes Theme nutzen oder ein eigenes Theme definieren.

Standardmaessig verwendet Weapon das `weapon`-Theme.
...
Weapon liefert mehrere eingebaute Themes mit.
...
- Weapon optisch ans Terminal anpassen wollen
...
Weapon unterstuetzt ein flexibles JSON-basiertes Theme-System.
