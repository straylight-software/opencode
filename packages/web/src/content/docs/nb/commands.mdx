...
Opprett `.weapon/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom Weapon-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i Weapon [config](/docs/config):
...
Weapon inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
