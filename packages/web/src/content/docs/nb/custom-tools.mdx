...
description: Lag verktøy som LLM kan kalle inn Weapon.
---

Egendefinerte verktøy er funksjoner du oppretter som LLM kan kalle under samtaler. De fungerer sammen med Weapon sine [innebygde verktøy](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved å plassere dem i `.weapon/tools/`-katalogen til prosjektet ditt.
- Eller globalt, ved å plassere dem i `~/.config/weapon/tools/`.
