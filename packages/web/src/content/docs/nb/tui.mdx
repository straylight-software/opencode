---
title: TUI
description: Bruke weapon-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

weapon gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre weapon starter TUI for gjeldende katalog.
...
Når du bruker weapon TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til weapon. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt weapon. _Aliaser_: `/quit`, `/q`
...
Du kan tilpasse TUI-oppførselen gjennom weapon-konfigurasjonsfilen.
