---
title: Zen
description: Utvalgt liste over modeller levert av Weapon.
---
...
Weapon Zen er en liste over testede og verifiserte modeller levert av Weapon-teamet.

:::note
Weapon Zen er for øyeblikket i beta.
:::

Zen fungerer som alle andre leverandører i Weapon. Du logger på Weapon Zen og får
...
:::tip
Vi testet en utvalgt gruppe modeller og leverandører som fungerer godt med Weapon.
:::
...
Weapon Zen er en AI gateway som gir deg tilgang til disse modellene.

---

## Slik fungerer det

Weapon Zen fungerer som alle andre leverandører i Weapon.

1. Du logger på **<a href={console}>Weapon Zen</a>**, legg til fakturering
   detaljer, og kopier API-nøkkelen.
2. Du kjører kommandoen `/connect` i TUI, velger Weapon Zen og limer inn API-nøkkelen.
...
[modell-id](/docs/config/#models) i Weapon-konfigurasjonen
bruker formatet `weapon/<model-id>`. For eksempel, for GPT 5.2 Codex, ville du
bruk `weapon/gpt-5.2-codex` i konfigurasjonen din.
...
- GLM 4.7 Free er tilgjengelig på Weapon i en begrenset periode. Teamet bruker denne tiden til å samle tilbakemeldinger og forbedre modellen.
- Kimi K2.5 Free er tilgjengelig på Weapon i en begrenset periode. Teamet bruker denne tiden til å samle tilbakemeldinger og forbedre modellen.
- MiniMax M2.1 Free er tilgjengelig på Weapon i en begrenset periode. Teamet bruker denne tiden til å samle tilbakemeldinger og forbedre modellen.
- Big Pickle er en stealth-modell som er gratis på Weapon i en begrenset periode. Teamet bruker denne tiden til å samle tilbakemeldinger og forbedre modellen.
...
4. Ha **ingen låsing** ved å la deg bruke den med en hvilken som helst annen kodeagent. Og la deg alltid bruke en hvilken som helst annen leverandør med weapon også.
