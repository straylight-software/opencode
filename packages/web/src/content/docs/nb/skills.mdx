...
Agentferdigheter lar Weapon oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går weapon opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
weapon viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `weapon.json`:
