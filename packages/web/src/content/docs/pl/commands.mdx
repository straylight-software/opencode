...
Utwórz `.weapon/commands/test.md`:
...
Możesz zdefiniować polecenia w `weapon.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji weapon:
...
- Globalnie: `~/.config/weapon/commands/`
- Na projekt: `.weapon/commands/`
...
weapon zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
