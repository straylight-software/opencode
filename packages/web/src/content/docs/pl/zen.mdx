---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez weapon.
---
...
Weapon Zen to lista przetestowanych i zweryfikowanych modeli udostępniona przez zespół weapon.

:::note
Weapon Zen is currently in beta.
:::

Zen działa jak każdy inny dostawca weapon. Logujesz się do Weapon Zen i dostajesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z weapon.
:::
...
Weapon Zen to brama AI, która zapewnia dostęp do tych modeli.

---

## Jak to działa

Weapon Zen działa jak każdy inny dostawca weapon.

1. Logujesz się do **<a href={console}>Weapon Zen</a>**, dodajesz swoje rozliczenia
   szczegóły i skopiuj klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz Weapon Zen i wklejasz klucz API.
...
[Identyfikator modelu](/docs/config/#models) w konfiguracji weapon
używa formatu `weapon/<model-id>`. Na przykład w przypadku Kodeksu GPT 5.2 zrobiłbyś to
użyj `weapon/gpt-5.2-codex` w swojej konfiguracji.
...
- GLM 4.7 Free jest dostępny na platformie weapon przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
- Kimi K2.5 Free jest dostępny na weapon przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
- MiniMax M2.1 Free jest dostępny na platformie weapon przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
- Big Pickle to ukryty model, który jest bezpłatny w weapon przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
...
4. Nie **nie blokuj**, umożliwiając używanie go z dowolnym innym agentem kodującym. I zawsze pozwalaj na korzystanie z weapon dowolnego innego dostawcy.
