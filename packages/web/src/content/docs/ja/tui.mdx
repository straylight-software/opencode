---
title: TUI
description: Weapon ターミナルユーザーインターフェイスの使用。
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Weapon は、LLM を使用してプロジェクトを作業するための対話型ターミナルインターフェイスまたは TUI を提供します。

Weapon を実行すると、現在のディレクトリの TUI が開始されます。
...
Weapon TUI を使用する場合、「`/`」に続いてコマンド名を入力すると、アクションをすばやく実行できます。例えば：
...
Weapon にプロバイダーを追加します。利用可能なプロバイダーから選択し、その API キーを追加できます。
...
Weapon 設定ファイルを通じて TUI の動作をカスタマイズできます。
