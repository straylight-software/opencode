---
title: TUI
description: 使用 Weapon 終端機使用者介面。
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Weapon 提供了一個互動式終端機介面或 TUI，供您與 LLM 一起處理專案。

執行 Weapon 會啟動當前目錄的 TUI。
...
使用 Weapon TUI 時，您可以輸入 `/` 後跟指令名稱來快速執行操作。例如：
...
將供應商添加到 Weapon。允許您從可用的供應商中進行選擇並添加其 API 金鑰。
