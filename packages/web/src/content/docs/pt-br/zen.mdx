---
title: Zen
description: Lista selecionada de modelos fornecidos pelo weapon.
---
...
O Weapon Zen é uma lista de modelos testados e verificados fornecidos pela equipe do weapon.

:::note
O Weapon Zen está atualmente em beta.
:::

O Zen funciona como qualquer outro provedor no weapon. Você faz login no Weapon Zen e obtém sua chave de API. É **completamente opcional** e você não precisa usá-lo para utilizar o weapon.
...
:::tip
Testamos um grupo selecionado de modelos e provedores que funcionam bem com o weapon.
:::
...
O Weapon Zen é um gateway de IA que lhe dá acesso a esses modelos.

---

## Como funciona

O Weapon Zen funciona como qualquer outro provedor no weapon.

1. Você faz login no **<a href={console}>Weapon Zen</a>**, adiciona seus dados de cobrança e copia sua chave de API.
2. Você executa o comando `/connect` no TUI, seleciona Weapon Zen e cola sua chave de API.
...
O [id do modelo](/docs/config/#models) na sua configuração do weapon usa o formato `weapon/<model-id>`. Por exemplo, para GPT 5.2 Codex, você usaria `weapon/gpt-5.2-codex` na sua configuração.
...
- GLM 4.7 Free está disponível no weapon por tempo limitado. A equipe está usando esse tempo para coletar feedback e melhorar o modelo.
- Kimi K2.5 Free está disponível no weapon por tempo limitado. A equipe está usando esse tempo para coletar feedback e melhorar o modelo.
- MiniMax M2.1 Free está disponível no weapon por tempo limitado. A equipe está usando esse tempo para coletar feedback e melhorar o modelo.
- Big Pickle é um modelo oculto que está gratuito no weapon por tempo limitado. A equipe está usando esse tempo para coletar feedback e melhorar o modelo.
...
4. Não ter **vinculação** permitindo que você o use com qualquer outro agente de codificação. E sempre permitir que você use qualquer outro provedor com o weapon também.
