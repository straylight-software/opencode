...
Kreiraj `.weapon/commands/test.md`:
...
Možete dodati prilagođene komande kroz Weapon konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom Weapon [config](/docs/config):
...
- Globalno: `~/.config/weapon/commands/`
- Po projektu: `.weapon/commands/`
...
Weapon uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
