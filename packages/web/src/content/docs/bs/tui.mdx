---
title: TUI
description: Korištenje korisničkog interfejsa Weapon terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Weapon pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje Weapon pokreće TUI za trenutni direktorij.
...
Kada koristite Weapon TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u Weapon. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz Weapon. _Aliases_: `/quit`, `/q`
...
Možete prilagoditi TUI ponašanje putem vašeg Weapon konfiguracionog fajla.
