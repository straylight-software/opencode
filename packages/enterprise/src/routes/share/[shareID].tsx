import { FileDiff, Message, Model, Part, Session, SessionStatus, UserMessage } from "@weapon-ai/sdk/v2"
import { SessionTurn } from "@weapon-ai/ui/session-turn"
import { SessionReview } from "@weapon-ai/ui/session-review"
import { DataProvider } from "@weapon-ai/ui/context"
import { DiffComponentProvider } from "@weapon-ai/ui/context/diff"
import { CodeComponentProvider } from "@weapon-ai/ui/context/code"
import { WorkerPoolProvider } from "@weapon-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createEffect, createMemo, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@weapon-ai/ui/logo"
import { IconButton } from "@weapon-ai/ui/icon-button"
import { ProviderIcon } from "@weapon-ai/ui/provider-icon"
import { createDefaultOptions } from "@weapon-ai/ui/pierre"
import { iife } from "@weapon-ai/util/iife"
...
import { Diff as SSRDiff } from "@weapon-ai/ui/diff-ssr"
import { clientOnly } from "@solidjs/start"
import { type IconName } from "@weapon-ai/ui/icons/provider"
import { Meta, Title } from "@solidjs/meta"
import { Base64 } from "js-base64"

const ClientOnlyDiff = clientOnly(() => import("@weapon-ai/ui/diff").then((m) => ({ default: m.Diff })))
const ClientOnlyCode = clientOnly(() => import("@weapon-ai/ui/code").then((m) => ({ default: m.Code })))
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@weapon-ai/ui/pierre/worker").then((m) => ({
      ...
      <Show when={data()}>
        {(data) => {
          ...
          const ogImage = createMemo(() => {
            ...
            return `https://social-cards.sst.dev/weapon-share/${encodedTitle}.png?model=${modelParam}&version=${version}&id=${data().shareID}`
          })

          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | // WEAPON //</Title>
              </Show>
              <Meta name="description" content="weapon - The AI coding agent built for the terminal." />
                          ...
                          <div class="relative bg-background-stronger w-screen h-screen overflow-hidden flex flex-col">
                            <header class="h-12 px-6 py-2 flex items-center justify-between self-stretch bg-background-base border-b border-border-weak-base">
                              ...
                              <div class="flex gap-3 items-center">
                                <IconButton
                                  as={"a"}
                                  href="https://github.com/anomalyco/weapon"
                                  target="_blank"
                                  icon="github"
                                  variant="ghost"
                                />
