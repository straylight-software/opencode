...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders WEAPON_CALLER", () => {
    process.env["WEAPON_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode WEAPON_CALLER", () => {
    process.env["WEAPON_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown WEAPON_CALLER", () => {
    process.env["WEAPON_CALLER"] = "unknown"
