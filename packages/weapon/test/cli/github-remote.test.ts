...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/weapon.git")).toEqual({ owner: "sst", repo: "weapon" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/weapon")).toEqual({ owner: "sst", repo: "weapon" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/weapon.git")).toEqual({ owner: "sst", repo: "weapon" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/weapon")).toEqual({ owner: "sst", repo: "weapon" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/weapon.git")).toEqual({ owner: "sst", repo: "weapon" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/weapon")).toEqual({ owner: "sst", repo: "weapon" })
})
