...
beforeAll(async () => {
  ...
  mock.module("@weapon-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@weapon-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@weapon-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@weapon-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
