...
import { resolveThemeVariant, useTheme, withAlpha, type HexColor } from "@weapon-ai/ui/theme"
...
export const Terminal = (props: TerminalProps) => {
  ...
  onMount(() => {
    const run = async () => {
      ...
      if (window.__WEAPON__?.serverPassword) {
        url.username = "weapon"
        url.password = window.__WEAPON__?.serverPassword
      }
