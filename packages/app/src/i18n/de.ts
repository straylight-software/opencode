...
export const dict = {
  ...
  "dialog.provider.weapon.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Weapon",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Weapon zu nutzen.",
  ...
  "provider.connect.weaponZen.line1":
    "Weapon Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.weaponZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.weaponZen.visit.link": "weapon.ai/zen",
  "provider.connect.weaponZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in Weapon zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Weapon zu nutzen.",
  ...
  "dialog.plugins.empty": "In weapon.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den Weapon-Server, mit dem sich diese App verbindet.",
  ...
  "toast.update.description": "Eine neue Version von Weapon ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Weapon-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (weapon.json) auf Anbieter-/Modellnamen",
  ...
  "sidebar.gettingStarted.line1": "Weapon enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "Weapon-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Weapon ändern",
  "settings.general.row.appearance.title": "Erscheinungsbild",
  "settings.general.row.appearance.description": "Anpassen, wie Weapon auf Ihrem Gerät aussieht",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Weapon anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Weapon automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von Weapon.",
