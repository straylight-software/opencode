export const dict = {
  ...
  "dialog.provider.weapon.note": "Curated models including Claude, GPT, Gemini and more",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Weapon",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Weapon.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.weaponZen.line1":
    "Weapon Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.weaponZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.weaponZen.visit.prefix": "Visit ",
  "provider.connect.weaponZen.visit.link": "weapon.ai/zen",
  "provider.connect.weaponZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Weapon.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Weapon.",
  ...
  "dialog.plugins.empty": "Plugins configured in weapon.json",
  ...
  "dialog.server.description": "Switch which Weapon server this app connects to.",
  ...
  "toast.update.description": "A new version of Weapon ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Weapon team",
  ...
  "error.chain.checkConfig": "Check your config (weapon.json) provider/model names",
  ...
  "sidebar.gettingStarted.line1": "Weapon includes free models so you can start immediately.",
  ...
  "settings.general.row.language.description": "Change the display language for Weapon",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Weapon looks on your device",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Weapon is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Weapon launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Weapon.",
