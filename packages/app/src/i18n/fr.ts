export const dict = {
  ...
  "dialog.provider.weapon.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Weapon",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Weapon.",
  ...
  "provider.connect.weaponZen.line1":
    "Weapon Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.weaponZen.visit.prefix": "Visitez ",
  "provider.connect.weaponZen.visit.link": "weapon.ai/zen",
  "provider.connect.weaponZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Weapon.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Weapon.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans weapon.json",
  ...
  "dialog.server.description": "Changez le serveur Weapon auquel cette application se connecte.",
  ...
  "toast.update.description":
    "Une nouvelle version d'Weapon ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Weapon",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (weapon.json) pour les noms de fournisseur/modèle",
  ...
  "sidebar.gettingStarted.line1":
    "Weapon inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Weapon dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Weapon",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Weapon sur votre appareil",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Weapon.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Weapon",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Weapon.",
