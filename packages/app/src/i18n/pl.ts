export const dict = {
  ...
  "dialog.provider.weapon.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Weapon",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Weapon.",
  ...
  "provider.connect.weaponZen.line1":
    "Weapon Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  "provider.connect.weaponZen.line2":
    "Z jednym kluczem API uzyskasz dostęp do modeli takich jak Claude, GPT, Gemini, GLM i więcej.",
  "provider.connect.weaponZen.visit.prefix": "Odwiedź ",
  "provider.connect.weaponZen.visit.link": "weapon.ai/zen",
  "provider.connect.weaponZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Weapon.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Weapon.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w weapon.json",
  ...
  "dialog.server.description": "Przełącz serwer Weapon, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja Weapon ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Weapon",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (weapon.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "Weapon zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Run the Weapon server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Weapon",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd Weapon na swoim urządzeniu",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Weapon.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Weapon",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Weapon.",
