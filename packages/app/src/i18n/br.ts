export const dict = {
  ...
  "dialog.provider.weapon.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Weapon",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Weapon.",
  ...
  "provider.connect.weaponZen.line1":
    "Weapon Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  "provider.connect.weaponZen.line2":
    "Com uma única chave de API você terá acesso a modelos como Claude, GPT, Gemini, GLM e mais.",
  "provider.connect.weaponZen.visit.prefix": "Visite ",
  "provider.connect.weaponZen.visit.link": "weapon.ai/zen",
  "provider.connect.weaponZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Weapon.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Weapon.",
  ...
  "dialog.plugins.empty": "Plugins configurados em weapon.json",
  ...
  "dialog.server.description": "Trocar para qual servidor Weapon este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do Weapon ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Weapon",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (weapon.json)",
  ...
  "sidebar.gettingStarted.line1": "Weapon inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Weapon dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Weapon",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o Weapon aparece no seu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Weapon é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Weapon iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Weapon.",
