export const dict = {
  ...
  "dialog.provider.weapon.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Weapon",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i Weapon.",
  ...
  "provider.connect.weaponZen.line1":
    "Weapon Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.weaponZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.weaponZen.visit.prefix": "Besøg ",
  "provider.connect.weaponZen.visit.link": "weapon.ai/zen",
  "provider.connect.weaponZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i Weapon.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i Weapon.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i weapon.json",
  ...
  "dialog.server.description": "Skift hvilken Weapon-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af Weapon ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Weapon-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (weapon.json) udbyder/modelnavne",
  ...
  "sidebar.gettingStarted.line1": "Weapon inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Weapon-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Weapon",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan Weapon ser ud på din enhed",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan Weapon er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Weapon starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Weapon.",
