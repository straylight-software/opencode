export const dict = {
  ...
  "dialog.provider.weapon.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Weapon",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Weapon-u.",
  ...
  "provider.connect.weaponZen.line1":
    "Weapon Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  "provider.connect.weaponZen.line2":
    "Sa jednim API ključem dobijaš pristup modelima kao što su Claude, GPT, Gemini, GLM i drugi.",
  "provider.connect.weaponZen.visit.prefix": "Posjeti ",
  "provider.connect.weaponZen.visit.link": "weapon.ai/zen",
  "provider.connect.weaponZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Weapon-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Weapon-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u weapon.json",
  ...
  "dialog.server.description": "Promijeni na koji se Weapon server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija Weapon-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Weapon timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (weapon.json) provider/model names",
  ...
  "sidebar.gettingStarted.line1": "Weapon uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Weapon server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Weapon-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako Weapon izgleda na tvom uređaju",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Weapon-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Weapon pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Weapon-a.",
