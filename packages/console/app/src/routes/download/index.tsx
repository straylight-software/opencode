...
import desktopAppIcon from "../../asset/lander/weapon-desktop-icon.png"
      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://weapon.ai/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>weapon.ai/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g weapon-ai")}>
                <code>
                  npm i -g <strong>weapon-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g weapon-ai")}>
                <code>
                  bun add -g <strong>weapon-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/weapon")}>
                <code>
                  brew install <strong>anomalyco/tap/weapon</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S weapon")}>
                <code>
                  paru -S <strong>weapon</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask weapon-desktop")}>
                <code>
                  brew install --cask <strong>weapon-desktop</strong>
                </code>
                <CopyStatus />
              </button>
