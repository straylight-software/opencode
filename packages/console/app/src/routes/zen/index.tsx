...
import compareVideo from "../../asset/lander/weapon-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/weapon-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="weapon:auth" content={loggedin() ? "true" : "false"} />
