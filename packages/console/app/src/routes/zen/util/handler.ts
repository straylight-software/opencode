...
import { and, Database, eq, isNull, lt, or, sql } from "@weapon-ai/console-core/drizzle/index.js"
import { KeyTable } from "@weapon-ai/console-core/schema/key.sql.js"
import { BillingTable, SubscriptionTable, UsageTable } from "@weapon-ai/console-core/schema/billing.sql.js"
import { centsToMicroCents } from "@weapon-ai/console-core/util/price.js"
import { getWeekBounds } from "@weapon-ai/console-core/util/date.js"
import { Identifier } from "@weapon-ai/console-core/identifier.js"
import { Billing } from "@weapon-ai/console-core/billing.js"
import { Actor } from "@weapon-ai/console-core/actor.js"
...
import { Black, BlackData } from "@weapon-ai/console-core/black.js"
...
import { ProviderTable } from "@weapon-ai/console-core/schema/provider.sql.js"
...
export async function handler(
  ...
  const FREE_WORKSPACES = [
    ...
    "wrk_01K6W1A3VE0KMNVSCQT43BG2SX", // weapon bench
  ]
  ...
  try {
    ...
    const sessionId = input.request.headers.get("x-weapon-session") ?? ""
    const requestId = input.request.headers.get("x-weapon-request") ?? ""
    const projectId = input.request.headers.get("x-weapon-project") ?? ""
    const ocClient = input.request.headers.get("x-weapon-client") ?? ""
    logger.metric({
      is_tream: isStream,
      session: sessionId,
      request: requestId,
    ...
    const retriableRequest = async (retry: RetryOptions = { excludeProviders: [], retryCount: 0 }) => {
      ...
      const res = await fetchWith429Retry(reqUrl, {
        ...
        headers: (() => {
          ...
          headers.delete("x-weapon-request")
          headers.delete("x-weapon-session")
          headers.delete("x-weapon-project")
          headers.delete("x-weapon-client")
          return headers
        })(),
        body: reqBody,
      })
  ...
  function validateBilling(authInfo: AuthInfo, modelInfo: ModelInfo): BillingSource {
    ...
    if (!billing.paymentMethodID)
      throw new CreditsError(
        `No payment method. Add a payment method here: https://weapon.ai/workspace/${authInfo.workspaceID}/billing`,
      )
    if (billing.balance <= 0)
      throw new CreditsError(
        `Insufficient balance. Manage your billing here: https://weapon.ai/workspace/${authInfo.workspaceID}/billing`,
      )
    ...
    if (
      ...
      throw new MonthlyLimitError(
        `Your workspace has reached its monthly spending limit of $${billing.monthlyLimit}. Manage your limits here: https://weapon.ai/workspace/${authInfo.workspaceID}/billing`,
      )
    ...
    if (
      ...
      throw new UserLimitError(
        `You have reached your monthly spending limit of $${authInfo.user.monthlyLimit}. Manage your limits here: https://weapon.ai/workspace/${authInfo.workspaceID}/members`,
      )
